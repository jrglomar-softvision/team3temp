...
public class ProjectServiceImpl implements ProjectService {
    ...
    @Override
    public Page<ProjectGetPeopleDTO> findPeopleByProjectId(Pageable pageable, Set<Integer> id, String status) throws Exception {
        ...
        if(StringUtils.isBlank(status)){
            ...
            if(status.equals("inactive"))
                ...
                throw new InvalidInputException("Invalid status input.");
        }
